...
public class ${className}Dto extends BaseDto
{
	...
	public ${className}Dyna get${className}Dyna()
	{
		return ${classNameLower}Dyna;
	}

	public void set${className}Dyna(${className}Dyna ${classNameLower}Dyna)
	{
		this.${classNameLower}Dyna = ${classNameLower}Dyna;
	}
	...
	public void set${className}s(List<${className}> ${classNameLower}s)
	{
		this.${classNameLower}s = ${classNameLower}s;
	}
}
